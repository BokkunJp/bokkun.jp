...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     *
     * @api  Smarty::isCached()
     * @link //www.smarty.net/docs/en/api.is.cached.tpl
     *
     ...
     * @link //www.smarty.net/docs/en/api.register.plugin.tpl
     *
     ...
     * @link //www.smarty.net/docs/en/api.load.filter.tpl
     *
     ...
     * @link //www.smarty.net/docs/en/api.register.filter.tpl
     *
     * @param  string      $type filter type
     ...
     * @link //www.smarty.net/docs/en/api.register.object.tpl
     *
