...
<!-- // 必要ファイル -->
<base href="../" />
<script src="/public/client/js/<?php echo basename(dirname(__DIR__)); ?>/index.js"></script>
<script src="/public/client/js/<?php echo basename(dirname(__DIR__)); ?>/WebGLProgram/shader.js"></script>
<script src="/public/client/js/<?php echo basename(dirname(__DIR__)); ?>/WebGLProgram/ProgramObject.js"></script>
<script src="/public/client/js/<?php echo basename(dirname(__DIR__)); ?>/WebGLProgram/BufferObject.js"></script>
<script src="/public/client/js/<?php echo basename(basename(dirname(__DIR__))); ?>/WebGLProgram/VBO.js"></script>
<script src="/public/client/js/<?php echo basename(basename(dirname(__DIR__))); ?>/WebGLProgram/IBO.js"></script>
<script src="/public/client/js/<?php echo basename(basename(dirname(__DIR__))); ?>/WebGLProgram/texture.js"></script>
<script src="/public/client/js/<?php echo basename(basename(dirname(__DIR__))); ?>/WebGLProgram/minMatrix.js"></script>
